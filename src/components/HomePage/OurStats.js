...
const AnimatedStatsSection = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      achievements: 'Expanded to multiple new cities in the last year',
      color: 'from-blue-400 to-blue-500',
    ...
    },
    {
      ...
      achievements: 'Mentors with practical industry experience',
      color: 'from-blue-400 to-blue-500',
    ...
    },
    {
      ...
      achievements: 'Live project experience for students.',
      color: 'from-blue-400 to-blue-500',
    ...
    },
    {
      ...
      achievements: 'Fortune companies and innovative startups',
      color: 'from-blue-400 to-blue-500',
